...
const MyProfile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'javierLunaM@gmail.com',
        phone: '+52 636 136 31 66',
        address: {
            line1: 'Rio Yaqui, 3666',
            line2: 'Col. Cordova Amercicas, Ciudad Juarez',
        },
        gender: 'Hombre',
        dob: '2000-04-27'
    })
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            <div>
                <p className='text-neutral-500 underline mt-3'>INFO BASICA</p>
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
            ...
            <div className='mt-10'>
                {
                    isEdit
                        ? <button onClick={() => setIsEdit(false)} className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>Guardar Info</button>
