    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Somos un centro de rehabilitación y terapia física con una amplia experiencia profesional en la rama de la rehabilitación4 física desde 2015 y hasta la fecha nuestro compromiso es mejorar la calidad de vida de cada uno de nuestros pacientes, por eso día a día nos seguimos actualizando en las novedades de terapia física.</p>
